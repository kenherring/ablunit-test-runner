...
usage () {
	echo "
usage: $0 [ -o (12.2.12 | 12.7.0 | 12.8.1 | 12.8.3 | 12.8.4 | 12.8.5 | 12.8.6 | 12.8.7 | 12.8.8 | all) ]
...
initialize () {
	...
	if [ "${ABLUNIT_TEST_RUNNER_OE_VERSION,,}" = "all" ]; then
		OE_VERSIONS=(12.2.12 12.7.0 12.8.1 12.8.3 12.8.4 12.8.5 12.8.6 12.8.7 12.8.8)
		...
		[ "$ABLUNIT_TEST_RUNNER_OE_VERSION" != '12.8.8' ]; then
