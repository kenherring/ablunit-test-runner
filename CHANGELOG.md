# [1.4.41](https://github.com/kenherring/ablunit-test-runner/releases/tag/1.4.41) - 2026-07-13 (pre-release)

* Temporarily skip test case proj2.7 (#597)
* build(deps-dev): bump eslint-plugin-promise from 7.2.1 to 7.3.0 (#579)
* build(deps): bump uuid from 8.3.2 to removed in the npm_and_yarn group across 1 directory (#575)
...
* build(deps): bump SonarSource/sonarqube-scan-action from 7.0.0 to 7.1.0 (#556)
* build(deps-dev): bump esbuild from 0.27.4 to 0.28.0 (#553)
* build(deps-dev): bump typescript-eslint from 8.57.2 to 8.58.0 (#555)
* actions: debug pull_request_target (#551)
* npm audit fix (#550)
* actions: debug pull_request_target (#547)
* build(deps-dev): bump lodash from 4.17.23 to 4.18.1 in /dummy-ext in the npm_and_yarn group across 1 directory (#549)
* build(deps): bump the npm_and_yarn group across 1 directory with 2 updates (#548)
* actions: debug pull_request_target (#546)
* actions: debug pull_request_target (#545)
* actions: debug pull_request_target (#544)
* actions: debug pull_request_target (#541)
* build(deps-dev): bump typescript-eslint from 8.57.1 to 8.57.2 (#543)
* actions: debug pull_request_target (#540)
* actions: debug pull_request_target (#539)
* actions: debug pull_request_target (#538)
* actions: debug pull_request_target (#537)
* actions: debug pull_request_target (#536)
...
**Full Changelog**: [1.4.4...1.4.41](https://github.com/kenherring/ablunit-test-runner/compare/1.4.4...1.4.41)
