# [1.3.93](https://github.com/kenherring/ablunit-test-runner/releases/tag/1.3.93) - 2025-11-12 (pre-release)

* Remove testing code from deployable (#441)
...
* Bump esbuild from 0.26.0 to 0.27.0 (#435)
* Bump typescript-eslint from 8.46.3 to 8.46.4 (#436)
* Bump mocha from 11.7.4 to 11.7.5 (#437)
...
**Full Changelog**: [1.3.0...1.3.93](https://github.com/kenherring/ablunit-test-runner/compare/1.3.91...1.3.93)
