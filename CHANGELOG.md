# [1.3.49](https://github.com/kenherring/ablunit-test-runner/releases/tag/1.3.49) - 2025-08-25 (pre-release)

* [WIP] Using JSON.stringify for object comparison is inefficient and unreliable. Consider implementing a proper equals method on SourceMapItem or using a more efficient deduplication strategy like a Set with a custom key. (#379)
...
* Prepare version 1.3.41 (#360, #370)
