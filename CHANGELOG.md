# [1.4.19](https://github.com/kenherring/ablunit-test-runner/releases/tag/1.4.19) - 2026-03-23 (pre-release)

* actions: skip bump_version.sh for pull_request_target (#520)
