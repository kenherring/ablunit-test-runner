# [1.3.53](https://github.com/kenherring/ablunit-test-runner/releases/tag/1.3.53) - 2025-09-25 (pre-release)

* Use vscode-abl extension hook to restart language server in extension tests (#397)
