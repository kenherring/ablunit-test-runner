...
convert_and_merge_xml () {
    ...
    echo "merged test results for sonar consumption.  output: artifacts/mocha_results_sonar/merged.xml"

}

show_summary () {
    jq '[ .testExecutions.file[].testCase
