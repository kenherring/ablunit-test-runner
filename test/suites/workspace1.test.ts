import { Uri, assert, deleteFile, doesDirExist, doesFileExist, log, runAllTests, updateConfig, waitForExtensionActive, workspace } from '../testCommon'

export default suite('workspace1', () => {
	...
	test('workspace1.2 - log.info only', () => {
		log.info('START 1.1')
	})
